...
Revision ID: 5e8fb5307522
Revises: 
Create Date: 2025-10-24 16:03:44.722619
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('unpaid', 'paid', 'canceled', name='invoicestatus', native_enum=False), nullable=False),
